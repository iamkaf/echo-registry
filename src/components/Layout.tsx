            ...
            <nav className="border-b border-border bg-panel/50 backdrop-blur-md sticky top-0 z-40">
                <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-6">
                        <a href="https://echo.iamkaf.com/openapi.json" target="_blank" rel="noreferrer" className="text-sm text-text-muted hover:text-white transition-colors">
                            OpenAPI
                        </a>
                        <a href="https://github.com/iamkaf/echo-registry" target="_blank" rel="noreferrer" className="text-sm text-text-muted hover:text-white transition-colors flex items-center gap-1.5 group">
                            GitHub
